...
func main() {
	...
	fmt.Printf("A %.1f\n", blockchain.CaluculateTotalAmount(walletA.BlockchainAddress()))
	fmt.Printf("B %.1f\n", blockchain.CaluculateTotalAmount(walletB.BlockchainAddress()))
	fmt.Printf("M %.1f\n", blockchain.CaluculateTotalAmount(walletM.BlockchainAddress()))
}
